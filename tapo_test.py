...
async def main():
    ...
    print(f"The energy consumed today has been {solar_energy_generated_today / 1000:.4g} kWh which is {solar_energy_generated_today / max_solar_energy:.1%} of the maximum energy generated this year ({max_solar_energy / 1000:.4g} kWh)."
          f"You saved {compute_costs(solar_energy_generated_today / 1000):.2f} € today. The mean energy consumption is {compute_mean_energy_consumption(df_energy_consumption):.2f} kWh.")
